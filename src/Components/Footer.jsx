    ...
    <div className={FooterCss.container}>
        <div className={FooterCss.main}>
           <div className={FooterCss.about}>
            <h1 className={FooterCss.heading}>
                Full-Stack Web Developer
            </h1>
            <p className={FooterCss.para}>My goal is to deliver seamless user experiences while continuously learning and adapting to new technologies. Let's connect and build something amazing together!</p>
        </div>
